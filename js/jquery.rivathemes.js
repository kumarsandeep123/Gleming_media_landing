(function($) {
    $.fn.rivaSlider = function(options) {
        var $this = this,
            ...
            $wrapper, $inner, scrol, qty, offsetLeft, fixH = 0,
            steps, bodyWidth, current = 0,
            isReadry = 0;
        var methods = {
            init: function() {
                if (!isReadry) {
...
(function($) {
    $.fn.rivaCarousel = function(options) {
        var $this = this,
            ...
            $wrapper, $inner, scrol, qty, steps, offsetLeft, bodyWidth, current = 0,
            isReadry = 0,
            v, fixW;
        var methods = {
            init: function() {
                ...
                if (bodyWidth > 768) {
                    ...
                    if ('undefined' == mobile_visible) mobile_visible = visible;
...
(function($) {
    $.fn.rivaCountdown = function(options) {
        var $this = this,
            ...
            endDate, today, mils, $daysValue = $this.find('#riva-countdown-days .value p'),
            ...
            dividers = new Array(86400, 3600, 60, 1),
            rest, t, values = new Array($daysValue, $hoursValue, $minsValue, $secsValue),
            timer_is_on = 0;
    ...
    $.fn.rivaSorting = function(options) {
        ...
        if (showAll) {
            ...
            $elems.hide().each(function() {
                if ($(this).hasClass($filters.find('[data-value]').first().attr('data-value'))) $(this).show();
            });
        }
